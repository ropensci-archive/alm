...
* PLOS test server at http://labs.lagotto.io (down as of 2016-09-17)
* Copernicus (down as of 2016-09-17)
* Public Knowledge Project (PKP) at <http://pkp-alm.lib.sfu.ca>
* Crossref at <http://eventdata.crossref.org>
* eLife at http://lagotto.svr.elifesciences.org (down as of 2016-09-17)
* Pensoft at http://alm.pensoft.net:81 (down as of 2016-09-17)
* Making Dat Count at <https://dlm.datacite.org/>
...
+ [ImpactStory](https://impactstory.org) - No open data (except for your own data)
+ [Altmetric.com](https://www.altmetric.com) - Some open data
+ [PlumAnalytics](http://plumanalytics.com) - No open data
