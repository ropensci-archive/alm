...
test_that("alm_datepub returns the correct value", {
	...
	expect_that(alm_datepub('10.1371/journal.pone.0026871', 'year', key=key), equals(2012))
})
...
test_that("alm_datepub returns the correct class", {
	...
	expect_that(alm_datepub('10.1371/journal.pone.0026871', 'year', key=key), is_a("numeric"))
})
