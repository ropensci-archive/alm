...
```{r alm1, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r alm2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r alm3, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r xxx, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r byyear, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
alm(doi='10.1371/journal.pone.0036240', sum_metrics='year')[,-c(6:8)]
```

## Output an-easy-to-combine-with-other-results data.frame

```{r easytocombine, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r totalmets, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r almevents, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r almtotals, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
almtotals(doi = '10.1371/journal.pbio.0000012')
```

## Get title of article by inputting the doi for the article.

```{r almtitle, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r signposts1, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.keep='high'}
...
```{r signposts2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plot_densityprep, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
library(rplos); library(plyr)
dois <- searchplos(terms='science', fields="id", toquery=list('cross_published_journal_key:PLoSONE', 'doc_type:full', 'publication_date:[2010-01-01T00:00:00Z TO 2010-12-31T23:59:59Z]'), limit=200)
```
...
```{r plot_densityprep2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE}
...
```{r plot_densityplot1, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.width=5, fig.height=4}
plot_density(alm)
```

You can change the color of the density plot

```{r plot_densityplot2, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.width=5, fig.height=4}
plot_density(alm, color="#EFA5A5")
```

Pass in a title or description subtending the title

```{r plot_densityplot3, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.width=5, fig.height=4}
plot_density(alm, title="Scopus citations from 2010")
```

Plot a particular source

```{r plot_densityplot4, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.width=5, fig.height=4}
names(alm)[1:35]
...
```{r plot_densityplot5, message=FALSE, warning=FALSE, comment=NA, cache=FALSE, fig.width=5, fig.height=4}
